        ...
        manejarTeclas(e) {
            ...
            if (this.ultimaTecla === 'g' && (ahora - this.ultimaTeclaTime) < 1000) {
                if (e.key === 'd') {
                    ...
                    e.preventDefault();
                    window.location.href = '<?= url('admin/equipos.php') ?>';
                }
                this.ultimaTecla = '';
            }
        }
        ...
        <div class="h-16 flex items-center border-b border-zinc-200 px-4 flex-shrink-0">
            <a href="<?= url('dashboard.php') ?>" class="flex items-center gap-2.5 overflow-hidden">
                ...
                <div x-show="sidebarAbierto" x-transition.opacity class="overflow-hidden">
                    ...
                    <img src="<?= url('assets/img/logo-negro.png') ?>" alt="<?= EMPRESA_NOMBRE ?>" onerror="this.style.display='none'"
                         class="h-5 w-auto block dark:hidden mt-0.5">
                    <img src="<?= url('assets/img/logo-blanco.png') ?>" alt="<?= EMPRESA_NOMBRE ?>" onerror="this.style.display='none'"
